...
echo '</tr>';
echo "<tr><td><button><a href='all_sp.php'>Специалист</a></button></td>
<td><button><a href='all_kl.php'>Клиент</a></button></td>
<td><button><a href='all_org.php'>Организация</a></button></td>
<td><button><a href='all_otdel.php'>Отделение</a></button></td>
</tr>";
echo "<tr><td><button><a href='all_ochered.php'>Статистика очереди по рабочему месту</a></button></td><td><button><a href='kl_block.php'>Статистика  заблокированных учетных записей</a></button></td></tr>";
        }
    }
}
}
